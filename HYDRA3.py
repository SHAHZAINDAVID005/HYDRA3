...
##   Author \tab : \tab SH4HZ41N D4V1D JO1Y4\par
##   Version \tab : \tab 2.1\par
##   Github \tab :                {{\field{\*\fldinst{HYPERLINK https://github.com/SHAHZAINDAVID005 }}{\fldrslt{https://github.com/SHAHZAINDAVID005\ul0\cf0}}}}\f1\fs22\lang1066\par
\par
\par
\par
...
##\par
##      Copyright (C) 2021  HTR-TECH ({{\field{\*\fldinst{HYPERLINK https://github.com/htr-tech }}{\fldrslt{https://github.com/htr-tech\ul0\cf0}}}}\f1\fs22 )\par
##\par
\par
\par
## ANSI colors (FG & BG)\par
RED="$(printf '\\033[31m')"  GREEN="$(printf '\\033[32m')"  ORANGE="$(printf '\\033[33m')"  BLUE="$(printf '\\033[34m')"\par
MAGENTA="$(printf '\\033[35m')"  CYAN="$(printf '\\033[36m')"  WHITE="$(printf '\\033[37m')" BLACK="$(printf '\\033[30m')"\par
REDBG="$(printf '\\033[41m')"  GREENBG="$(printf '\\033[42m')"  ORANGEBG="$(printf '\\033[43m')"  BLUEBG="$(printf '\\033[44m')"\par
MAGENTABG="$(printf '\\033[45m')"  CYANBG="$(printf '\\033[46m')"  WHITEBG="$(printf '\\033[47m')" BLACKBG="$(printf '\\033[40m')"\par
RESETBG="$(printf '\\e[0m\\n')"\par
\par
## Directories\par
